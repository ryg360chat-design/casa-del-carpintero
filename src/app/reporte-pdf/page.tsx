...
export default async function ReportePDFPage() {
  ...
  return (
    <html lang="es">
      <head>
        <title>Reporte Diario — Casa del Carpintero</title>
        <style>{`
      ...
      <body>
        ...
        <div className="print-bar">
          <div>
            ...
            <div className="print-sub capitalize">{fechaHoy}</div>
          </div>
          <button className="print-btn" onClick={() => { if (typeof window !== 'undefined') window.print(); }}>
            ...
            <div className="header-top">
              <div className="logo">
                ...
                <div>
                  ...
                  <div className="logo-sub">RyG SaaS · Reporte de producción</div>
                </div>
              </div>
          ...
          <div className="body">
            ...
            <div className="vol-grid">
              {[
                ...
                { value: totalPiezas, label: "Total piezas hoy", bg: "rgba(249,115,22,0.08)", stroke: "#f97316", path: "M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" },
