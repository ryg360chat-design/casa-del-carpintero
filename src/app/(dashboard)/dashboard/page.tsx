            ...
            <div key={id} className="animate-fade-in-up" style={{ animationDelay: `${200 + colIdx * 80}ms` }}>
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2.5">
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center transition-all duration-300 ${activa ? "bg-zinc-900 shadow-[0_0_12px_rgba(0,0,0,0.25)]" : "bg-zinc-100"}`}>
                    <svg
