            ...
            {pedidos.length === 0 ? (
              <div className="text-center py-16 animate-fade-in">
                <div className="w-16 h-16 rounded-2xl bg-zinc-100 flex items-center justify-center mx-auto mb-4">
                  {hayFiltros ? (
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="1.5"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
                  ) : (
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="1.5"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                  )}
                </div>
                <p className="text-sm font-semibold text-zinc-700 mb-1">
                  {hayFiltros ? "Sin resultados" : "Sin pedidos este día"}
                </p>
                <p className="text-xs text-zinc-400 max-w-[220px] mx-auto">
                  {hayFiltros ? "Prueba ajustando los filtros o cambiando la fecha." : "Cuando registres pedidos para este día aparecerán aquí."}
                </p>
              </div>
            ) : (
              <>
                    ...
                    <td colSpan={8}>
                      <div className="text-center py-14 animate-fade-in">
                        <div className="w-14 h-14 rounded-2xl bg-zinc-100 flex items-center justify-center mx-auto mb-3">
                          {hayFiltros
                            ? <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="1.5"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
                            : <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="1.5"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                          }
                        </div>
                        <p className="text-sm font-semibold text-zinc-700 mb-1">
                          {hayFiltros ? "Sin resultados" : "Aún no hay pedidos"}
                        </p>
                        <p className="text-xs text-zinc-400 mb-4 max-w-[200px] mx-auto">
                          {hayFiltros ? "Prueba ajustando los filtros." : "Registra tu primer pedido y aparecerá aquí."}
                        </p>
                        {!hayFiltros && (
                          <Link href="/pedidos/nuevo" className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-white rounded-xl" style={{ background: "#1957A6" }}>
                            <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M12 5v14"/></svg>
                            Crear primer pedido
                          </Link>
                        )}
                      </div>
