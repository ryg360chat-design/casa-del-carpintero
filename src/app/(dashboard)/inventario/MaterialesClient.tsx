                    ...
                    <td colSpan={canEdit ? 6 : 5}>
                      <div className="text-center py-12 animate-fade-in">
                        <div className="w-12 h-12 rounded-2xl bg-zinc-100 flex items-center justify-center mx-auto mb-3">
                          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="1.5"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>
                        </div>
                        <p className="text-sm font-semibold text-zinc-600 mb-1">Sin materiales</p>
                        <p className="text-xs text-zinc-400">No hay materiales para este filtro.</p>
                      </div>
                    </td>
                  </tr>
                )}
          ...
          {movimientos.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 animate-fade-in">
              <div className="w-14 h-14 rounded-2xl bg-zinc-100 flex items-center justify-center mb-3">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#a1a1aa" strokeWidth="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
              </div>
              <p className="text-sm font-semibold text-zinc-600">Sin movimientos aún</p>
              <p className="text-xs text-zinc-400 mt-1">Los ingresos y salidas de stock aparecen aquí.</p>
            </div>
          ) : (
            <table className="w-full text-sm">
              <thead>
