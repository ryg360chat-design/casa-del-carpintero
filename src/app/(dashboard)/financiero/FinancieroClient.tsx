    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* Navegación de mes — va primero en mobile para que sea prominente */}
          <div className="flex items-center gap-2 bg-white border border-zinc-200 rounded-xl px-3 py-2 shadow-sm flex-1 sm:flex-none justify-between">
            ...
            <span className="text-sm font-bold text-zinc-800 min-w-[120px] text-center capitalize">
              {MESES[mes - 1]} {año}
            </span>
            <button
              onClick={() => navMes(1)}
